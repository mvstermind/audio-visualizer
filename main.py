...
def main():
    ...
    for file in files:
        loudest_avg, loudest_chunk_list = loudest_audio_chunk(file)


def loudest_audio_chunk(file: str) -> Tuple[float, List[Any]]:
    ...
    # must be here otherwise it will have sum garbage value
...
def plot_waveform_with_loudest(
    ...
    plt.plot(time, data, color="blue", linewidth=0.8, label="waveformik")
